...
var PublishStewProperties = function(prototype,managed) {
 ...
 var Publisher = function(doc,outputFile,report,dryRun,pandocOpts) {
     this.doc = doc;
 ...
 Publisher.prototype.convertToHTMLUsingLibreOffice = function(file) {
     ...
     return libreoffice.convertToHTML(file,
 ...
 Publisher.prototype.compileDocument = function() {
     ...
     var args = this.pandocOpts.concat(["-s","-o",this.outputFile]).concat(this.filesToCompile);
     if (this.dryRun) {
 ...
 * */ 
 var Publishable = module.exports.Publishable = function(prototype) {
      ...
      * */
     prototype.publish = function(outputFile,report,dryRun,pandocOpts) {

         var publisher = new Publisher(this,outputFile,report,dryRun,pandocOpts);
