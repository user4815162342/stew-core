...
module.exports.convertToHTML = function(file,outputDir,profileFolder,dryRun) {
     ...
     var args = ["-env:UserInstallation=file:///" + profileFolder,"--headless","--convert-to","html:HTML","--outdir",outputDir,file];
     if (dryRun) {
     ...
     return Q(path.join(outputDir,path.basename(file,path.extname(file)) + ".html"));
