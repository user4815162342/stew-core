...
var DirectoryIndex = module.exports.DirectoryIndex = function(prototype,ContentItem,dontSort) {
    ...
    var filterItems = function(list,filter) {
        var result = [];
        return utils.promiseForEach(list,function(doc) {
    ...
    prototype.matchDocs = function(pattern) {
        ...
        if (pattern instanceof minimatch.Minimatch) {
            ...
            return utils.promiseForEach(patternSet,function(pattern) {
...
debugger;                
                ...
                return this.matchDocs(patternItem).then(function(docs) {
                    ...
                    return utils.promiseForEach(docs,function(doc) {
                ...
                return this.matchDocs(patternItem).then(function(docs) {
                    ...
                    return Q(docs.filter(function(doc) {
 ...
 * */
var ProjectRootContent = module.exports.ProjectRootContent = function(project) {
    this._project = project;
    this._path = "/";
}

DirectoryIndex(ProjectRootContent.prototype,Doc);

PathFunctions(ProjectRootContent.prototype);
