 ...
 * */
var get = module.exports.getPropertyFunc = function(name,defalt,transform) {
 ...
 * */
var getOrSet = module.exports.getOrSetPropertyFunc = function(name,defalt,transformIn,transformOut) {
...
var StatusDefinitions = function(prototype,managed) {
    ...
    mappedProperties(prototype,"Status","statuses",function(data) {
...
StatusDefinitions.initialize = function(data) {
    // have to update some older versions of the properties.
    if (data.statuses.join) {
        var convertedStatuses = {};
        for (var i = 0; i < data.statuses.length; i += 1) {
            convertedStatuses[data.statuses[i]] = {};
        }
        data.statuses = convertedStatuses;
    }
}
...
var Status = function(prototype,managed) {
    ...
    var changeStatus = function(delta) {
        // TODO: Since statuses are now an object map, this doesn't really work anymore.
        return function() {
            throw new StewError("Sorry, statuses can't be incremented up and down anymore. I'm working on a solution, let me know if this is a priority for you.");
...
var mix = function(init,mixins) {
    ...
    // This function makes 'plugins' more possible.
    constructor.extendProperties = function(mixin) {
        mixin(constructor.prototype,managedProperties);
        if (mixin.initialize) {
            initializers.push(mixin.initialize);
        }
    }
    mixins.forEach(function(mixin) {
        constructor.extendProperties(mixin);
    });
    return constructor;
}
 ...
 * */
var CategoryDefinition = module.exports.CategoryDefinition = mix(function(data) {
    this._data = data;
},[
    UnmanagedProperties,
    UserProperty,
 ...
 * Used internally to create an object which can edit the CategoryDefinitions.
 * */
var StatusDefinition = module.exports.StatusDefinition = mix(function(data) {
    this._data = data;
},[
    UnmanagedProperties,
    UserProperty,
